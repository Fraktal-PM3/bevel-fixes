...
namespaces:
  ...
  predefined:
    ...
    - name: default
      ...
      {{- else if or .Values.config.fabconnectUrl .Values.fabconnect.enabled }}
      ...
      multiparty:
        ...
        contract:
          ...
          - location:
              {{- if .Values.fabconnect.enabled }}
              chaincode: {{ .Values.fabconnect.fabric.chaincodeName }}
              channel: {{ .Values.fabconnect.fabric.channelName }}
              {{- else }}
